...
PathMut: str = r'.\Image\Multiplayer.jpg'
PathHyp: str = r'.\Image\Hypixel.jpg'
PathJon: str = r'.\Image\Join.jpg'
PathCan: str = r'.\Image\Cancel.jpg'
PathGam: str = r'.\Image\GameMenu.jpg'
PathSky: str = r'.\Image\SkyblockIcon.jpg'
PathDon: str = r'.\Image\Done.jpg'
PathSer: str = r'.\Image\Server.jpg'
PathIsl: str = r'.\Image\Island.jpg'
PathVil: str = r'.\Image\Village.jpg'
        ...
        while True:
            if logFlag == True or loggedFlag == False:
                ...
                while True:
                    ...
                    if (Polling == putChestTime or Polling == 1) and PutChestFlag:
                        if Polling % 2 == 0:
                            turn90R()
                            put2store()
                            turn90L()
