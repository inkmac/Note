...
Rev1.3.6:   change Islandleft IslandRight function to IslandTP1/2/3/4. next version need to add pollingtime for 4 TP.
            
            
"""
VersionD = "Rev_1.3.5"
# todo next version need to add pollingtime for 4 TP
...
PathAllList = [PathMult, PathHypi, PathJoin, PathCanc, PathGame, PathSkyb, PathDone, PathServ, PathIsla, PathVill, PathBack, PathTick]
# todo display on UI
                ...
                for each in PathList:
                    ...
                    if ScreenImg_ is None:
                        ...
                        if each == PathSkyb:
                            ...
                            cv2.imwrite(".\ImageTemp\screenPartImg" + str(PollingLog) + '_' + str(PollingSerPic)
                                        + ".jpg", screenPartImg)
