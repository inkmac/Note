...
class MainFunWindow(QMainWindow, Ui_MainWindow):
    ...
    def UiInitialData(self):
        ...
        for each in self.ConfList:
            if each[0] == 'lineEditLR':
                ...
                Spare_4 = int(each[1])
            elif each[0] == 'lineEditSpare_5':
                Spare_5 = int(each[1])
            elif each[0] == 'lineEditSpare_6':
                Spare_6 = int(each[1])
            elif each[0] == 'lineEditSpare_7':
                Spare_7 = int(each[1])
        ...
        self.labelSpare_5.setText(str(Spare_5))
        self.labelSpare_6.setText(str(Spare_6))
        self.labelSpare_7.setText(str(Spare_7))
    ...
    def applyData(self):
        ...
        if self.lineEditSpare_5.text() != '':
            Spare_5 = int(self.lineEditSpare_5.text())
            self.labelSpare_5.setText(str(Spare_5))
            self.lineEditSpare_5.setText('')
        if self.lineEditSpare_6.text() != '':
            Spare_6 = int(self.lineEditSpare_6.text())
            self.labelSpare_6.setText(str(Spare_6))
            self.lineEditSpare_6.setText('')
        if self.lineEditSpare_7.text() != '':
            Spare_7 = int(self.lineEditSpare_7.text())
            self.labelSpare_7.setText(str(Spare_7))
            self.lineEditSpare_7.setText('')
